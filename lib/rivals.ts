...
const ATP_SEEDS: Seed[] = [
  ...
  { first: "Alexande", last: "Zverev", nat: "GER", age: 28, hand: "right", backhand: "one", height: 198, weight: 90, style: "aggressive-baseline", favSurface: "hard", ovr: 90, injury: 40, currentAbility: 90, potentialAbility: 92 },
  ...
  { first: "Novak", last: "Djokovic", nat: "SRB", age: 38, hand: "right", backhand: "two", height: 188, weight: 77, style: "all-around", favSurface: "hard", ovr: 88, injury: 35, currentAbility: 88, potentialAbility: 90 },
  { first: "Casper", last: "Ruud", nat: "NOR", age: 26, hand: "right", backhand: "two", height: 183, weight: 77, style: "defensive-baseline", favSurface: "clay", ovr: 86, injury: 18, currentAbility: 86, potentialAbility: 88 },
  ...
  { first: "Grigor", last: "Dimitrov", nat: "BUL", age: 34, hand: "right", backhand: "one", height: 191, weight: 80, style: "all-around", favSurface: "hard", ovr: 84, injury: 45, currentAbility: 84, potentialAbility: 86 },
  { first: "Stefan", last: "Tsitsipas", nat: "GRE", age: 27, hand: "right", backhand: "one", height: 193, weight: 89, style: "aggressive-baseline", favSurface: "clay", ovr: 84, injury: 30, currentAbility: 84, potentialAbility: 88 },
  { first: "Alex", last: "De Minaur", nat: "AUS", age: 27, hand: "right", backhand: "two", height: 183, weight: 69, style: "defensive-baseline", favSurface: "hard", ovr: 83, injury: 24, currentAbility: 83, potentialAbility: 86 },
  { first: "Tomas", last: "Machac", nat: "CZE", age: 25, hand: "right", backhand: "two", height: 188, weight: 80, style: "aggressive-baseline", favSurface: "hard", ovr: 82, injury: 20, currentAbility: 82, potentialAbility: 86 },
  { first: "Ben", last: "Shelton", nat: "USA", age: 23, hand: "left", backhand: "two", height: 193, weight: 88, style: "serve-volley", favSurface: "hard", ovr: 82, injury: 18, currentAbility: 82, potentialAbility: 88 },
  { first: "Lorenzo", last: "Mussetti", nat: "ITA", age: 23, hand: "right", backhand: "one", height: 185, weight: 78, style: "all-around", favSurface: "clay", ovr: 81, injury: 26, currentAbility: 81, potentialAbility: 88 },
  ...
  { first: "France", last: "Tiafoe", nat: "USA", age: 27, hand: "right", backhand: "two", height: 188, weight: 80, style: "all-around", favSurface: "hard", ovr: 80, injury: 25, currentAbility: 80, potentialAbility: 84 },
  ...
  { first: "Flavio", last: "Cobolli", nat: "ITA", age: 24, hand: "right", backhand: "two", height: 183, weight: 74, style: "defensive-baseline", favSurface: "clay", ovr: 82, injury: 20, currentAbility: 82, potentialAbility: 88 },
  { first: "Alexander", last: "Bublik", nat: "KAZ", age: 28, hand: "right", backhand: "two", height: 196, weight: 82, style: "serve-volley", favSurface: "grass", ovr: 85, injury: 25, currentAbility: 85, potentialAbility: 89 },
  ...
  { first: "Learner", last: "Tien", nat: "USA", age: 20, hand: "left", backhand: "two", height: 180, weight: 73, style: "defensive-baseline", favSurface: "hard", ovr: 80, injury: 20, currentAbility: 80, potentialAbility: 92 },
  { first: "Valentin", last: "Vacherot", nat: "MON", age: 27, hand: "right", backhand: "two", height: 193, weight: 85, style: "aggressive-baseline", favSurface: "hard", ovr: 84, injury: 25, currentAbility: 84, potentialAbility: 85 },
  { first: "Arthur", last: "Fils", nat: "FRA", age: 22, hand: "right", backhand: "two", height: 185, weight: 83, style: "aggressive-baseline", favSurface: "clay", ovr: 85, injury: 20, currentAbility: 85, potentialAbility: 93 },
  { first: "Alejandro", last: "Davidovich Fokina", nat: "ESP", age: 27, hand: "right", backhand: "two", height: 183, weight: 78, style: "all-around", favSurface: "clay", ovr: 83, injury: 25, currentAbility: 83, potentialAbility: 84 },
  ...
  { first: "Francisco", last: "Cerundolo", nat: "ARG", age: 27, hand: "right", backhand: "two", height: 185, weight: 80, style: "aggressive-baseline", favSurface: "clay", ovr: 85, injury: 25, currentAbility: 85, potentialAbility: 87 },
