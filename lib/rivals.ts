...
const WTA_SEEDS: Seed[] = [
  ...
  { first: "Jésica", last: "Pegula", nat: "USA", age: 31, hand: "right", backhand: "two", height: 170, weight: 65, style: "all-around", favSurface: "hard", ovr: 87, injury: 20, currentAbility: 87, potentialAbility: 88 },
  { first: "Jasmine", last: "Paolini", nat: "ITA", age: 29, hand: "right", backhand: "two", height: 163, weight: 58, style: "defensive-baseline", favSurface: "clay", ovr: 85, injury: 18, currentAbility: 85, potentialAbility: 88 },
  ...
  { first: "Mirra", last: "Andreeva", nat: "RUS", age: 18, hand: "right", backhand: "two", height: 170, weight: 60, style: "all-around", favSurface: "hard", ovr: 84, injury: 16, currentAbility: 84, potentialAbility: 98 },
